...
const LongPutVisualizer = () => {
  ...
  const generatePayoffData = () => {
    ...
    for (let price = 0; price <= 200; price += 1) {
      // Long put payoff = max(-premium, price - strike - premium)
      const payoff = Math.max(-premium, strikePrice - price - premium);
  ...
  const getCurrentValue = () => {
    return Math.max(-premium, strikePrice - currentPrice - premium).toFixed(2);
  };
    ...
    <div className="space-y-6 p-4">
      <Card>
        <CardContent className="pt-6">
          <h2 className="text-xl font-bold mb-4">Long Put Strategy Payoff</h2>
          ...
          <div className="space-y-6">
            ...
            <div className="p-4 bg-gray-100 rounded-lg">
              ...
              <ul className="space-y-2">
                ...
                <li>Maximum Profit: ${(strikePrice - premium).toFixed(2)} (if price goes to 0)</li>
      ...
      <Card>
        <CardContent className="pt-6">
          ...
          <ul className="space-y-2 list-disc pl-4">
            <li>You buy a put option and pay a premium upfront</li>
            <li>You have the right (but not obligation) to sell at the strike price</li>
            <li>If price falls below strike, you profit (minus premium paid)</li>
            <li>Break-even point is strike price minus premium paid</li>
            <li>Maximum loss is limited to the premium paid</li>
            <li>This strategy is bearish - you profit when the price falls below strike</li>
          </ul>
        </CardContent>
      </Card>
    </div>
...
export default LongPutVisualizer;